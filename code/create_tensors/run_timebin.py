...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Process ODT tensors for cities using time bins.")
    ...
    parser.add_argument('--input-csv', type=str, required=True,
                        help='Path to the input CSV file containing ODT data')
    ...
    processor = TimebinProcessor(config, tensor_name=args.tensor_name)
    processor.run()
